...
* **K8s Namespace**: unless otherwise specified, this template assumes, by default, a mapping of GitHub organization ~ K8s namespace i.e. string replace {{K8S_NAMESPACE}} with your K8s namespace (or use the [essesseff onboarding utility](https://github.com/essesseff/essesseff-onboarding-utility) to perform string replacement automatically)
